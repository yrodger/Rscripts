...
##The table format is more helpful. This will give you a table with each locus that has private alleles as the top row and the next rows are how many private alleles in each population/region you have chosen to compare.
